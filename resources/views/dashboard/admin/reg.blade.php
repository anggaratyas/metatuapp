...
@section('judul_page','Tambah Data Penduduk')
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          <label>Nama Lengkap</label>
                            <input name="nama_lengkap" type="name" class="form-control" placeholder="Nama Lengkap">                         
                        </div>

                        <div class="form-group">
                          <label>Tempat Lahir</label>
                            <input name="tempat_lahir" type="name" class="form-control" placeholder="Tempat Lahir">                         
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input name="tgl_lahir" type="text" class="form-control" id="datepicker" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="skul" class="form-control select2" style="width: 100%;">
                        ...
                        <div class="form-group">
                          ...
                          <input name="tlp" type="text" class="form-control" data-inputmask='"mask": "99999999999999"' data-mask>                       
                        </div>
                    ...
                    <form class="form-horizontal">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <select name="jenis_kel" class="form-control select2" style="width: 100%;">
                        ...
                        <div class="form-group">
                          ...
                          <input name="kk" type="text" class="form-control" data-inputmask='"mask": "9999999999999999"' data-mask>                                                  
                        </div>

                        <div class="form-group">
                          <label>Nama Ibu Kandung</label>
                            <input name="ibu" type="name" class="form-control" placeholder="Nama Ibu">                         
                        </div>

                        <div class="form-group">
                          <label>Nama Ayah Kandung</label>
                            <input name="ayah" type="name" class="form-control" placeholder="Nama Ayah">                         
                        </div>

                        <div class="form-group">
                          <label>Kewarganegaraan</label>
                          <select name="kwn" class="form-control select2" style="width: 100%;">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        <label>Alamat Identitas</label>
                          <input name="alamat" type="name" class="form-control" placeholder="Alamat Identitas">                         
                      </div>
                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-xs-3">
                            <label>RT</label>
                            <input name="rt" type="text" class="form-control" data-inputmask='"mask": "999"' data-mask>
                          </div>
                          <div class="col-xs-3">
                            <label>RW</label>
                            <input name="rw" type="text" class="form-control" data-inputmask='"mask": "999"' data-mask>
                          </div>
                        </div>                  
                      </div>
                      ...
                      <div class="form-group">
                        <label>KodePos</label>
                        <input name="kdpos" type="text" class="form-control" data-inputmask='"mask": "9999999"' data-mask>                        
                      </div>
