      ...
      @endif
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="/penduduk/{{ $penduduk->id }}">
                            @method('patch')
                            @csrf                      
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="text" class="form-control" name="nama_lengkap" value="{{ $penduduk->nama_lengkap }}"/>                                                    
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" name="tlp" value="{{ $penduduk->tlp }}"/>
                                                </div>
                                            </div>  
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input name="tgl_lahir" type="text" class="form-control datepicker" value="{{ $penduduk->tgl_lahir }}"/>                                            
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12"> 
                                                    <select name="jenis_kel" class="form-control select" >
                                                        <option>{{ $penduduk->jenis_kel }}</option>
                                                <option>L</option>
                                                <option>P</option>
                                                    </select>
                                                </div>
                            ...
                            <option>Kong Hu Cu</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">    
                                                <select name="skul" class="form-control select" data-live-search="true" value="{{ $penduduk->skul }}">
                                                <option>{{ $penduduk->skul }}</option>
                            ...
                            <option>Strata 3</option>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" name="ibu" value="{{ $penduduk->ibu }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">                                            
                                                    <input type="text" class="form-control" name="ayah" value="{{ $penduduk->ayah }}" />
                                                </div>
                                            </div>                                        
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                <select name="kwn" class="form-control select" value="{{ $penduduk->kwn }}" >
                                                <option>{{ $penduduk->kwn }}</option>
                                                <option>WNI</option>
                                                <option>WNA</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="tab-pane" id="tab-alamat">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-xs-3">                                            
                                                  <label>RT</label>
                                                  <input name="rt" type="text" class="form-control" value="{{ $penduduk->rt }}" />
                                                </div>
                                                <div class="col-md-3 col-xs-3">                                            
                                                    <label>RW</label>
                                                  <input name="rw" type="text" class="form-control" value="{{ $penduduk->rw }}"/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="panel-footer">                                                                        
                                        <button type="/penduduk/create" class="btn btn-primary pull-right">Simpan Perubahan<span class="fa fa-floppy-o fa-right"></span></button>
                                    </div>
                                </div>                                
